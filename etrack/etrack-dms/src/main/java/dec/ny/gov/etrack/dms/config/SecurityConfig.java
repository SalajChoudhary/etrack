...
import dec.ny.gov.etrack.dms.util.MultitenantResolver;
import dec.ny.gov.etrack.dms.util.JWTTokenConverter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.cors().and().antMatcher("/etrack-dms/dms/**").authorizeRequests().antMatchers("*")
