...
public @Data class FacilityBIN implements Serializable {
  ...
  @Id
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "E_FACILITY_BIN_S")
  @SequenceGenerator(name = "E_FACILITY_BIN_S", sequenceName = "E_FACILITY_BIN_S", allocationSize = 1)
